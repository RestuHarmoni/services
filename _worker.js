...
<body>
<nav class="nav"><div class="container inner"><a class="brand" href="../index.html"><img src="../assets/rh-logo.png" alt="Restu Harmoni"><span>RESTU HARMONI<br><small>Digital Solutions</small></span></a><div class="links"><a href="../index.html#services">Servis</a><a href="../index.html#process">Proses</a><a href="../blog.html">Blog</a><a class="cta" href="../index.html#aira-popup">Hubungi</a></div></div></nav>
<main class="article"><div class="container"><span class="badge">${esc(category)}</span><h1>${esc(post.title || title)}</h1><p class="desc">${esc(description)}</p><div class="cover"><img src="${esc(image)}" alt="${esc(post.title || title)}"></div><article class="content"><div class="meta">Diterbitkan oleh Restu Harmoni Digital Solutions</div>${body || `<p>${esc(description)}</p>`}<div class="cta-box"><div><h2>Nak website untuk bisnes anda?</h2><p>Restu Harmoni bantu bina website yang kemas, mobile friendly dan mudah pelanggan hubungi melalui WhatsApp.</p></div><a href="../index.html#aira-popup">Dapatkan Cadangan Website</a></div></article></div></main>
...
export default {
  async fetch(request, env, ctx) {
    ...
    if (url.pathname === '/admin-office' || url.pathname === '/admin-office/' || url.pathname === '/admin-office.html') {
      return Response.redirect(`${url.origin}/admin.html?v=v9.0-production-cleanup`, 302);
    }
