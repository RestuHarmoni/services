(function(){
  ...
  function editPost(id){
    ...
    $('deletePostBtn').classList.remove('hidden'); $('previewPostBtn').classList.remove('hidden'); $('previewPostBtn').href='blog/'+encodeURIComponent(p.slug||'')+'.html';
  ...
  window.RH_BLOG_ADMIN={refreshPosts,newPost,get client(){return client;},get posts(){return posts;}};
